...
class UserAddedToGroup implements ShouldBroadcastNow
{
     ...
     * @return void
     */
    public function __construct($info,$group_id,$notification)
    {
        $this->info = $info;
    ...
    {
        \Log::debug(['info'=> $this->info,'group_id'=>$this->group_id,'notification'=>$this->notification]);
